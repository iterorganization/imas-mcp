...
class DataSourceScanner(Protocol):
    ...
    Lifecycle:
        ...
        2. (shared) enrichment via LLM classification
...
def get_scanners_for_facility(facility: str) -> list[DataSourceScanner]:
    ...
    Reads data_sources from facility config and returns scanners for
    each configured data source type.
...
def _auto_register() -> None:
    ...
    from imas_codex.discovery.data.scanners import (  # noqa: F401
        edas,
        imas,
        mdsplus,
        ppf,
