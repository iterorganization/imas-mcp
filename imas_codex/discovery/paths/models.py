...
class TriagedDirectory:
    ...
    def to_graph_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "triage_analysis_code": self.score_analysis_code,
            "triage_operations_code": self.score_operations_code,
            "triage_modeling_data": self.score_modeling_data,
            "triage_experimental_data": self.score_experimental_data,
            "triage_data_access": self.score_data_access,
            "triage_workflow": self.score_workflow,
            "triage_visualization": self.score_visualization,
            "triage_documentation": self.score_documentation,
            "triage_imas": self.score_imas,
            "triage_convention": self.score_convention,
            "triage_composite": self.score,
