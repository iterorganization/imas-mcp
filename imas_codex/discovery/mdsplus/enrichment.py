"""LLM-based enrichment models and prompt builders for MDSplus tree nodes.

Provides Pydantic models for structured LLM output and prompt
construction helpers used by discovery/static/workers.py and the
prompt_loader schema provider.
"""
