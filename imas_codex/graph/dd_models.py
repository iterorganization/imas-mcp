...
linkml_meta = LinkMLMeta(
    {
        ...
        "source_file": "/home/ITER/mcintos/Code/imas-codex.worktrees/worktree-2026-01-05T11-25-27/imas_codex/schemas/imas_dd.yaml",
...
class DDVersion(ConfiguredBaseModel):
    ...
    embeddings_built_at: datetime | None = Field(
        default=None,
        description="""Timestamp when embeddings were generated for this version""",
        json_schema_extra={
            "linkml_meta": {"alias": "embeddings_built_at", "domain_of": ["DDVersion"]}
        },
    )
    embeddings_model: str | None = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"alias": "embeddings_model", "domain_of": ["DDVersion"]}
        },
    )
    embeddings_count: int | None = Field(
        default=None,
        description="""Number of paths with embeddings in this version""",
        json_schema_extra={
            "linkml_meta": {"alias": "embeddings_count", "domain_of": ["DDVersion"]}
        },
    )
    clusters_built_at: datetime | None = Field(
        default=None,
        description="""Timestamp when clusters were generated for this version""",
        json_schema_extra={
            "linkml_meta": {"alias": "clusters_built_at", "domain_of": ["DDVersion"]}
        },
    )
    clusters_count: int | None = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"alias": "clusters_count", "domain_of": ["DDVersion"]}
        },
    )
...
class IMASPath(ConfiguredBaseModel):
    ...
    embedding_text: str | None = Field(
        default=None,
        description="""Pre-concatenated context for embedding: combines IDS description, parent path context, documentation, units, and coordinates into natural language prose optimized for sentence transformer embedding.""",
        json_schema_extra={
            "linkml_meta": {"alias": "embedding_text", "domain_of": ["IMASPath"]}
        },
    )
    embedding: list[float] | None = Field(
        default=None,
        description="""384-dim embedding vector. Model tracked on DDVersion.embeddings_model. Use Neo4j vector index for semantic search.""",
        json_schema_extra={
            "linkml_meta": {"alias": "embedding", "domain_of": ["IMASPath"]}
        },
    )
    embedding_hash: str | None = Field(
        default=None,
        description="""SHA256 hash of embedding_text content. Used for cache busting - if hash changes, embedding needs regeneration. Enables minimal recompute on rebuild.""",
        json_schema_extra={
            "linkml_meta": {"alias": "embedding_hash", "domain_of": ["IMASPath"]}
        },
    )
...
class SemanticCluster(ConfiguredBaseModel):
    ...
    centroid: list[float] | None = Field(
        default=None,
        description="""Cluster centroid embedding vector (384-dim, L2-normalized). Mean of member path embeddings. Enables hierarchical search: first match clusters by centroid, then search within cluster.""",
        json_schema_extra={
            "linkml_meta": {"alias": "centroid", "domain_of": ["SemanticCluster"]}
        },
    )
    ...
    scope: str | None = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"alias": "scope", "domain_of": ["SemanticCluster"]}
        },
    )
    scope_detail: str | None = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"alias": "scope_detail", "domain_of": ["SemanticCluster"]}
        },
    )
    ids_names: list[str] | None = Field(
        default=None,
        description="""List of IDS names represented in this cluster""",
        json_schema_extra={
            "linkml_meta": {"alias": "ids_names", "domain_of": ["SemanticCluster"]}
        },
    )
    physics_concepts: list[str] | None = Field(
        default=None,
        description="""Physics concepts covered by this cluster""",
        json_schema_extra={
            "linkml_meta": {
                "alias": "physics_concepts",
                "domain_of": ["SemanticCluster"],
            }
        },
    )
    mapping_relevance: str | None = Field(
        default=None,
        description="""Relevance for IMAS mapping (high, medium, low)""",
        json_schema_extra={
            "linkml_meta": {
                "alias": "mapping_relevance",
                "domain_of": ["SemanticCluster"],
            }
        },
    )
