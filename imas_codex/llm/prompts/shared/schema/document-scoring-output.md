...
```json
{{ document_scoring_schema_example }}
```

### Field Requirements

{{ document_scoring_schema_fields }}

### Critical Rules

1. Return ONE result per input document, in the same order as input
...
7. The `id` field MUST exactly match the input document ID
