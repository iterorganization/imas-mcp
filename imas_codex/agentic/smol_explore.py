"""
Smolagents-based facility exploration agent.
...
Usage:
    ...
    async with SmolExplorationAgent("iter") as agent:
...
class SmolExplorationAgent:
    ...
    async def __aenter__(self) -> SmolExplorationAgent:
    ...
    def __enter__(self) -> SmolExplorationAgent:
    ...
    async def explore(self, prompt: str | None = None) -> SmolExplorationResult:
        ...
        Returns:
            SmolExplorationResult with summary and statistics
        """
    ...
    def explore_sync(self, prompt: str | None = None) -> SmolExplorationResult:
...
async def explore_facility(
    ...
    Convenience function that wraps SmolExplorationAgent.
