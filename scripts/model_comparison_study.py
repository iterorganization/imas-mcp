...
# Expanded to 30 test cases for statistical significance
TEST_DIRECTORIES = [
    # =========================================================================
    # HIGH VALUE (10 cases) - Should score >= 0.7
    # =========================================================================
    {
    ...
    {
        "path": "/work/imas/shared/iterscenariodb",
        "total_files": 200,
        "total_dirs": 40,
        "has_readme": True,
        "has_makefile": False,
        "has_git": True,
        "file_type_counts": {"py": 150, "json": 30, "yaml": 20},
        "patterns_detected": ["IMAS", "ids", "scenario", "equilibrium"],
        "child_names": [
            "scenario_db.py",
            "ids_tools.py",
            "equilibrium_db.py",
        ...
        "expected_purpose": "analysis_code",
        "reason": "ITER scenario database with IMAS integration",
    },
    {
    ...
    # =========================================================================
    # MEDIUM VALUE (10 cases) - Should score 0.4-0.7
    # =========================================================================
    {
    ...
    },
    {
        ...
        "expected_score_min": 0.4,
        "expected_purpose": "analysis_code",
        "reason": "Shot review analysis scripts",
    },
    {
    ...
    },
    {
        ...
        "reason": "Teaching materials, educational but not research code",
    },
    {
        ...
        "expected_score_min": 0.4,
        "expected_purpose": "analysis_code",
        "reason": "Generic postprocessing scripts",
    },
    {
        ...
        "patterns_detected": ["MDSplus", "density"],
        "child_names": [
            "interferometer.py",
    ...
    {
        "path": "/home/user/projects/ml_disruption",
        "total_files": 35,
        "total_dirs": 5,
        "has_readme": True,
        "has_makefile": False,
        "has_git": True,
        "file_type_counts": {"py": 25, "ipynb": 5, "h5": 5},
        "patterns_detected": ["MDSplus"],
        "child_names": [
            "train_model.py",
            "predict.py",
        ...
        "expected_score_min": 0.5,
        "expected_purpose": "analysis_code",
        "reason": "ML disruption prediction project",
    },
    # =========================================================================
    # LOW VALUE (10 cases) - Should score < 0.4
    # =========================================================================
    {
    ...
    },
    {
        ...
        "has_makefile": False,
        "has_git": False,
        "file_type_counts": {"dat": 300, "tmp": 150, "out": 50},
        "patterns_detected": [],
        "child_names": [
            "output.dat",
            "temp_001.tmp",
        ...
        "expected_score_min": 0.0,
        "expected_purpose": "system",
        "reason": "Temporary job directory",
    },
    {
    ...
    },
    {
        ...
        "expected_score_min": 0.0,
        "expected_purpose": "user_home",
        "reason": "Downloads folder, no structured code",
    },
    {
    ...
    },
    {
        ...
        "expected_score_min": 0.0,
        "expected_purpose": "user_home",
        "reason": "Papers and documents, not code",
    },
    {
        ...
        "expected_score_min": 0.0,
        "expected_purpose": "data_storage",
        "reason": "Simulation output archive, data not code",
    },
    {
        "path": "/home/user/.local/share/jupyter",
        "total_files": 500,
        "total_dirs": 50,
        "has_readme": False,
        "has_makefile": False,
        "has_git": False,
        "file_type_counts": {"json": 400, "sqlite": 10, "log": 90},
        "patterns_detected": [],
        "child_names": [
            "runtime/",
            "kernels/",
